(function() {
	...
	function LoginService($http, $cookies, $location, AdminService, CartService) {
	...
	LoginService.$inject = [ '$http' , '$cookies' , '$location' , 'AdminService' , 'CartService' ];
